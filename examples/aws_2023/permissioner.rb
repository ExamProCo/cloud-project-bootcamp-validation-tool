class Aws2023::Permissioner
  def self.run(general_params:,specific_params:)
    ...
    self.add primary_region, :ecs_describe_tasks, {cluster_name: specific_params.cluster_name, task_ids: task_ids}
    self.add 'global', :cloudfront_get_distribution
    self.add 'global', :cloudfront_list_invalidations
    self.add 'global', :s3api_get_bucket_notification_configuration
    self.add 'global', :s3api_get_bucket_policy
    self.add 'global', :s3api_get_bucket_cors
    self.add 'global', :s3api_get_bucket_website
    self.add 'global', :s3api_get_bucket_website
    self.add 'global', :s3api_get_public_access_block
