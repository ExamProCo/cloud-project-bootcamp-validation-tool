Cpbvt::Tester::Runner.describe :cicd do
  spec :should_have_a_codepipeline do
  ...
  spec :should_have_a_source_from_github do |pipeline_name, github_full_repo_name|
  ...
  spec :should_have_a_build_stage do |pipeline_name|
  ...
  spec :should_have_a_deploy_stage do |pipeline_name|
